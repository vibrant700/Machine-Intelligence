...
指标	数值
总轮数	20 轮
初始损失	0.6480411163871637
最终损失	0.030135718365521577
最终准确率	97.81%
...
# 定义网络
# 层的顺序: Linear -> BatchNorm -> ReLU -> Dropout
...
net = Base_Classes.Sequential(
    [
        ...
        classes.Dropout(p=0.1),  # Dropout: 防止过拟合，丢弃10%神经元
        # 第二层: 256 -> 128
