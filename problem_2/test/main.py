...
def solve_8_digital_problem(f_input, f_goal, f_n):
    if function.determine_solvability(f_input, f_goal, f_n) is False:
        ...
        # 调用类方法，定义类参数
        forward_Node.set_puzzle_params(f_n, forward_hamilton_distance_table)
...
def test(test_times, n):
    ...
    for i in range(test_times):
        ...
        if node_1 and node_2:
            print(function.get_path_forward(node_1), end="")
            print(function.get_path_backward(node_2))
